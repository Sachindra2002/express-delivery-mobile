...
public class ViewPackageAgentActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        String result = AuthHandler.validate(ViewPackageAgentActivity.this, "agent");
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        NavHandler.handleAgentNav(item, ViewPackageAgentActivity.this);
