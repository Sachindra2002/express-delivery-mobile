...
public class AgentDriverProfileActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        String result = AuthHandler.validate(AgentDriverProfileActivity.this, "agent");
        ...
        setContentView(R.layout.activity_agent_driver_profile);
    ...
    private void getDriverDocuments() {
        Call<List<Documents>> call = agentClient.getDriverDocuments(token, getIntent().getStringExtra("driver_email"));
        ...
        call.enqueue(new Callback<List<Documents>>() {
            ...
            public void onFailure(Call<List<Documents>> call, Throwable t) {
                Toast.makeText(AgentDriverProfileActivity.this, "Something went Wrong!" + t.toString(), Toast.LENGTH_SHORT).show();
                mProgressDialog.dismiss();
            }
        });
    }
