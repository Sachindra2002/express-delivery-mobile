...
public class TransitListActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    TextView home_name;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        String result = AuthHandler.validate(TransitListActivity.this, "agent");
    ...
    private void getTransitPackages() {
        Call<List<Mail>> call = agentClient.getAllTransitMails(token);
        ...
        call.enqueue(new Callback<List<Mail>>() {
            ...
            public void onResponse(Call<List<Mail>> call, Response<List<Mail>> response) {
                ...
                if (mails != null) {
                    ...
                    Toast.makeText(TransitListActivity.this, "Something went wrong" + response.toString(), Toast.LENGTH_SHORT).show();
                }
            ...
            public void onFailure(Call<List<Mail>> call, Throwable t) {
                Toast.makeText(TransitListActivity.this, "Something went Wrong!" + t.toString(), Toast.LENGTH_SHORT).show();
                mProgressDialog.dismiss();
            }
        });
    }
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        NavHandler.handleAgentNav(item, TransitListActivity.this);
    ...
    protected void onResume() {
        super.onResume();
        //Check if authorization token is valid
        AuthHandler.validate(TransitListActivity.this, "agent");
    }
