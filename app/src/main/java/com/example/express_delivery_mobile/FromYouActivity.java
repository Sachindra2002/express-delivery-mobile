...
public class FromYouActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        String result = AuthHandler.validate(FromYouActivity.this, "customer");
        ...
        //Load layout
        setContentView(R.layout.activity_from_you_mails);
    ...
    private void getAllOutgoingMails() {
        Call<List<Mail>> call = mailClient.getAllOutgoingMails(token);
        ...
        call.enqueue(new Callback<List<Mail>>() {
            ...
            public void onResponse(Call<List<Mail>> call, Response<List<Mail>> response) {
                ...
                if(mails != null){
                    ...
                    Toast.makeText(FromYouActivity.this, "Something went wrong" + response.toString(), Toast.LENGTH_SHORT).show();
                }
            ...
            public void onFailure(Call<List<Mail>> call, Throwable t) {
                Toast.makeText(FromYouActivity.this, "Something went Wrong!" + t.toString(), Toast.LENGTH_SHORT).show();
                mProgressDialog.dismiss();
            }
        });
    }
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        NavHandler.handleCustomerNav(item, FromYouActivity.this);
