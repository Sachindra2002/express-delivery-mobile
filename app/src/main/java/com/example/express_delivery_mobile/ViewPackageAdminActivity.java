...
public class ViewPackageAdminActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        String result = AuthHandler.validate(ViewPackageAdminActivity.this, "admin");
        ...
        setContentView(R.layout.activity_view_package_admin);
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        NavHandler.handleAdminNav(item, ViewPackageAdminActivity.this);
